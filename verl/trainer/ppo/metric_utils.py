...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    clipped_diversity = batch.batch["clipped_diversity"]
    ...
    valid_clipped_diversity = torch.masked_select(clipped_diversity, response_mask)
    ...
    metrics = {
        ...
        # clipped_diversity
        "critic/clipped_diversity/mean": torch.mean(valid_clipped_diversity).detach().item(),
        "critic/clipped_diversity/max": torch.max(valid_clipped_diversity).detach().item(),
        "critic/clipped_diversity/min": torch.min(valid_clipped_diversity).detach().item(),
        **(
            {
                # values
